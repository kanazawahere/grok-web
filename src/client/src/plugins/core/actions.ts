...
export function createCoreActions(): PluginAction[] {
  return [
    ...
    },
    {
      id: "machine.add",
      title: "Add Machine",
      description: "Register another Grok Web runtime reachable from this gateway",
      group: "Machine",
    ...
    },
    {
      ...
      description: "Check whether the selected Grok Web runtime is online",
      group: "Machine",
      run: (context) => context.refreshSelectedMachine(),
    },
    {
      id: "machine.open",
      title: "Open Selected Machine Grok Web",
      description: "Open the selected remote Grok Web directly in a new tab",
      group: "Machine",
    ...
    },
    {
      id: "theme.select",
      title: "Select Theme",
      description: "Choose the Grok Web color theme",
      group: "Preferences",
    ...
    },
    {
      id: "settings.open",
      title: "Open Settings",
      description: "Manage Grok Web configuration and keyboard shortcuts",
      shortcut: "mod+,",
      group: "Preferences",
    ...
    },
    {
      ...
      description: "Reload the Grok Web browser page",
      group: "General",
